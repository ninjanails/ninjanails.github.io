...
Sans-serif fonts such as Arial, Verdana, and Comic Sans can work well for dyslexics even though they aren’t specifically designed for them. (The serifs in serif fonts may obscure the shape of a character causing letters to run together and become harder to read.[](http://uxmovement.com/content/6-surprising-bad-practices-that-hurt-dyslexic-users/
))
